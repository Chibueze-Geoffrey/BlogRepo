...
namespace TechDaily.Apllication.Implementations
{
    public class AuthorService : IAuthorService
    {
        ...
        ApiResponse<PaginatedResponse<AuthorResponseDto>> IAuthorService.UpdateAuthor(int pageSize, int pageNumber)
        {
            ...
            if (authors == null)
            {
                authors = _unitOfWork.Repository<Author>().Update();
                _cache.Set("authors", authors);
            }
            ...
            return ApiResponse<PaginatedResponse<AuthorResponseDto>>
                .Success(paginatedResponse, "Successfully updated authors");
